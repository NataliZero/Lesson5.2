...
parrot.make_sound()        # Выведет: Parrot chirps.
parrot.fly()               # Выведет: Parrot is flying.
elephant.make_sound()       # Выведет: Elephant makes mammal sound.
elephant.show_fur()         # Выведет: Elephant does not have fur.
snake.make_sound()          # Выведет: Snake hisses.
snake.show_temperature_regulation()  # Выведет: Snake is cold-blooded.
